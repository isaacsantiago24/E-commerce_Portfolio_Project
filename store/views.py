...
# from django.contrib.auth.forms import UserCreationForm #already exists in django
...
def register(request):
    if request.method == 'POST':
        form = UserRegisterForm(request.POST) #POST data is coming from our form 
        if form.is_valid(): 
            ...
            #this will tell us if our data is valid
            username= form.cleaned_data.get('username') #this will save the valid data
